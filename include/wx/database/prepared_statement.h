#ifndef _WX_DATABASE_PREPARED_STATEMENT_H_
#define _WX_DATABASE_PREPARED_STATEMENT_H_

#include "wx/database/wxprec.h"

WX_DECLARE_HASH_SET( wxDatabaseResultSet*, wxPointerHash, wxPointerEqual, StatementResultSetHashSet );

class WXDLLIMPEXP_DATABASE wxPreparedStatement : public wxDatabaseErrorReporter, public wxDatabaseStringConverter
{
public:
  /// Constructor
  wxPreparedStatement();
  ...
  wxDatabaseResultSet* ExecuteQuery() { return RunQueryWithResults(); }
...
#endif//_WX_DATABASE_PREPARED_STATEMENT_H_
